...
% Xcommands = output_preditionnet(1,:);           
% Ycommands = output_preditionnet(2,:);          
% Zcommands = output_preditionnet(3,:);  
% Acommands = output_preditionnet(4,:);  
% Ccommands = output_preditionnet(5,:);
